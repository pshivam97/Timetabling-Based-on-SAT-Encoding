...
get_ipython().system(' export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:~/workspace/z3-4.7.1-x64-debian-8.10/bin')
get_ipython().system(' export PYTHONPATH=~/workspace/z3-4.7.1-x64-debian-8.10/bin/python')
